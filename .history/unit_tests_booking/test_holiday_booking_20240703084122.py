...
if __name__ == "__main__":
    ...
    with open(csv_file, mode='w', newline='') as file:
        ...
        for test_result in result.failures + result.errors:
            test_name = str(test_result[0]).split()[0]  # Extract test name from the failure/error
            writer.writerow({
                'id': '',
                'module': '',
                'name': test_name,
        ...
        for test_result in result.successes:
            test_name = str(test_result[0]).split()[0]  # Extract test name from the success
            writer.writerow({
                'id': '',
                'module': '',
                'name': test_name,
