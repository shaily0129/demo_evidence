...
test_file_path = "/Users/shailygoyal/Desktop/demo_evidence/unit_tests/test_holiday_booking.py"
...
try:
    ...
    data_row = [test_file_path, coverage_txt_filename, coverage_html_directory, current_datetime]
    ...
    print(f"Error while running subprocess command: {e}")
