...
This service fetchs documents by entering user ID. When user request documents, it sends back a list of pages from a specific document called ["Prolonged_Casualty_Care_Guidelines"](/static/21-12_JTS_Prolonged_Casualty_Care_Guidelines (1).pdf).
